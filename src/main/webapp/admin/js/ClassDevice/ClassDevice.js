var classDevice={
		serverUrl:'/admin/classDevice/',		
		fmtOperate:function(val, row, index){
			return '<a href="javascript:void(0);" onclick="classDevice.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="classDevice.del('+val+')">删除</a>';
		},
		openCreate:function(){
		...
		search:function(){
			...
			$('#site-datagrid').datagrid("reload",{className:className,deviceName:deviceName,deviceCode:deviceCode});		
		},
