var sysConfig={
		serverUrl:'/admin/sysConfig/',
		fmtOperate:function(val, row, index){
			return '<a href="javascript:void(0);" onclick="sysConfig.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="sysConfig.del('+val+')">删除</a>';
		},
		openCreate:function(){
