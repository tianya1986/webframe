var pwdConfig={
	serverUrl:'/admin/pwdConfig/',
	fmtOperate:function(val, row, index){
		return '<a href="javascript:void(0);" onclick="pwdConfig.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="pwdConfig.del('+val+')">删除</a>';
	},
	openCreate:function(){
	...
	search:function(){
		var name=$("#name").val();
		var code=$("#code").val();
		$('#site-datagrid').datagrid("reload",{name:name,code:code});
	},
	save:function(){
