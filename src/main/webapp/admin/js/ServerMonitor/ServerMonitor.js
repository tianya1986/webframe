var serverMonitor={
		serverUrl:'/admin/serverMonitor/',		
		fmtOperate:function(val, row, index){
			return '<a href="javascript:void(0);" onclick="serverMonitor.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="sserverMonitor.del('+val+')">删除</a>';
		},
		openCreate:function(){
