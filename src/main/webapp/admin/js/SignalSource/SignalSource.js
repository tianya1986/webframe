var signalSource={
		serverUrl:'/admin/signalSource/',		
		fmtOperate:function(val, row, index){
			return '<a href="javascript:void(0);" onclick="signalSource.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="signalSource.del('+val+')">删除</a>';
		},
		openCreate:function(){
		...
		search:function(){
			...
			var signalCode=$("#className").val();	
			$('#site-datagrid').datagrid("reload",{className:className,signalName:signalName,signalCode:signalCode});	
		},
