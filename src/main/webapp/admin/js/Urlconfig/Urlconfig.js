var urlConfig={
		serverUrl:'/admin/urlConfig/',
		fmtOperate:function(val, row, index){
			return '<a href="javascript:void(0);" onclick="urlConfig.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="urlConfig.del('+val+')">删除</a>';
		},
		openCreate:function(){
		...
		search:function(){
			var area=$("#area").val();
			var code=$("#code").val();
			$('#site-datagrid').datagrid("reload",{area:area,code:code});
		},
