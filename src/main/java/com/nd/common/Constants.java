...
public class Constants {
    ...
    /**预监控域名-状态：初始创建*/
    public static final int PRE_MONITOR_DOMAIN_STATUS_INIT = 0;
    /**预监控域名-执行状态：成功*/
    public static final int PRE_MONITOR_DOMAIN_STATUS_SUCCESS = 1;
    /**预监控域名-状态：执行失败*/
    public static final int PRE_MONITOR_DOMAIN_STATUS_FAILURE = 2;
    /**预监控域名-操作：默认*/
    public static final int PRE_MONITOR_DOMAIN_OPERATOR_DEFAULT = 0;
    /**预监控域名-操作：创建成功后直接执行*/
    public static final int PRE_MONITOR_DOMAIN_OPERATOR_DIRECT = 1;
    /**预监控域名-操作：定时操作*/
    public static final int PRE_MONITOR_DOMAIN_OPERATOR_TIME = 2;
}
